...
class Classifier(nn.Module):
    def __init__(self, regression=False):
        ...
        self.mlp = MLPClassifier(input_size=out_dim, hidden_size=cmd_args.hidden, num_class=cmd_args.num_class, p=cmd_args.dropout)
        ...
        if regression:
            ...
            self.mlp = MLPRegression(input_size=out_dim, hidden_size=cmd_args.hidden, p=cmd_args.dropout)
